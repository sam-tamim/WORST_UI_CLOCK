...
function showDateConfirmation() {
  ...
  confirmationStep.innerHTML = `
    <div style="text-align: center; margin-bottom: 10px;">
      ...
      <p style="font-size: 12px; color: #666;">
        On which date do you want this alarm? Use Roman buttons to adjust.
      </p>
    </div>
  `;
    ...
    <div class="date-math-container">
      <div class="roman-math-controls">
        ...
        <div class="date-unit" id="day-control">
          ...
          <!-- REMOVED the separate day value display -->
        </div>
        ...
        <div class="date-unit" id="month-control">
          ...
          <!-- REMOVED the separate month value display -->
        </div>
        ...
        <div class="date-unit" id="year-control">
          ...
          <!-- REMOVED the separate year value display -->
        </div>
      </div>
      
      <!-- Selected Date Display (this shows everything) -->
      ...
      ">
        <i class="fas fa-calendar-alt"></i> Selected: ${formatDateFull(today)}
      </div>
      
      <div style="text-align: center; font-size: 12px; color: #666; margin-top: 10px;">
        <i class="fas fa-info-circle"></i> Use the Roman numeral buttons above to adjust the date
      </div>
    </div>
  `;
  ...
  function updateDateDisplay() {
    document.getElementById('selected-date-display').innerHTML = 
      `<i class="fas fa-calendar-alt"></i> Selected: <strong>${formatDateFull(selectedDate)}</strong>`;
  }
